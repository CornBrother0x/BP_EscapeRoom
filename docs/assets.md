...
| `public/audio/voicemail.mp3`     | P1 password, read aloud (radio-fuzzed)| Brett's own voice recording, processed through an ffmpeg AM-radio chain                          | Original recording by Brett — owned, cleared for use        |
| `public/audio/hey.mp3`           | Smiley "hey" whisper (proximity chorus)| macOS `say -v Whisper "hey"`, pitched down + echo via ffmpeg                                    | Apple system TTS output, processed; non-commercial portfolio |
